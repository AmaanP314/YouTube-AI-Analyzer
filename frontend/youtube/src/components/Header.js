...
import { Search, Mic, Youtube, MoreVertical } from "lucide-react";
  ...
  return (
    <header className="flex items-center justify-between px-4 py-2 h-14 sticky top-0 z-50 bg-youtube-dark border-b border-youtube-gray-border">
      ...
      <form
        ...
        className="flex-grow max-w-[732px] flex items-center justify-center px-2 sm:px-4"
      >
        <div className="flex w-full max-w-[640px]">
          <input
            ...
            className="flex-grow px-4 py-[9px] bg-youtube-dark-tertiary border border-youtube-gray-border rounded-l-full focus:outline-none focus:border-blue-500 text-youtube-gray-primary placeholder-youtube-gray-secondary text-base leading-6"
          />
          <button
            type="submit"
            className="px-4 sm:px-6 py-[9px] bg-youtube-dark-secondary border border-youtube-gray-border border-l-0 rounded-r-full hover:bg-[#383838] flex items-center justify-center"
          >
        ...
        <button
          type="button"
          className="ml-2 sm:ml-4 p-[9px] bg-youtube-dark-secondary rounded-full hover:bg-[#383838] flex items-center justify-center"
          onClick={() => console.log("Mic clicked")}
        >
          <Mic size={20} className="text-youtube-gray-primary" />
        </button>
      </form>

      {/* Right section: User Actions */}
      <div className="flex items-center space-x-1 sm:space-x-2 flex-shrink-0">
        <button className="p-2 focus:outline-none focus:bg-youtube-dark-secondary rounded-full">
          <MoreVertical size={20} className="text-white" />
        </button>
        <button className="flex items-center space-x-2 border border-youtube-gray-border rounded-full px-3 py-1.5 text-blue-400 hover:bg-blue-900/30">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24"
            viewBox="0 0 24 24"
            width="24"
            focusable="false"
            className="fill-current rounded-full w-6 h-6"
          >
